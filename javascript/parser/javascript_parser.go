...
func (p *JavaScriptParser) ExpressionStatement() (localctx IExpressionStatementContext) {
	...
	if !(this.notOpenBraceAndNotFunction()) {
		p.SetError(antlr.NewFailedPredicateException(p, "this.notOpenBraceAndNotFunction()", ""))
		goto errorExit
	}
	{
		p.SetState(355)
...
func (p *JavaScriptParser) IterationStatement() (localctx IIterationStatementContext) {
		...
		if p.GetInterpreter().AdaptivePredict(p.BaseParser, p.GetTokenStream(), 29, p.GetParserRuleContext()) == 1 {
			{
				...
				goto errorExit} else if p.GetInterpreter().AdaptivePredict(p.BaseParser, p.GetTokenStream(), 29, p.GetParserRuleContext()) == 2 {
			{
				p.SetState(384)
				p.VariableDeclarationList()
			}
	...
	case 5:
		...
		if !(this.p("of")) {
			p.SetError(antlr.NewFailedPredicateException(p, "this.p(\"of\")", ""))
			goto errorExit
		}
		{
			p.SetState(419)
...
func (p *JavaScriptParser) ContinueStatement() (localctx IContinueStatementContext) {
	...
	if p.GetInterpreter().AdaptivePredict(p.BaseParser, p.GetTokenStream(), 37, p.GetParserRuleContext()) == 1 {
		...
		if !(this.notLineTerminator()) {
			p.SetError(antlr.NewFailedPredicateException(p, "this.notLineTerminator()", ""))
			goto errorExit
		}
		{
			p.SetState(432)
		...
		if p.GetInterpreter().AdaptivePredict(p.BaseParser, p.GetTokenStream(), 56, p.GetParserRuleContext()) == 1 {
			{
				...
				goto errorExit} else if p.GetInterpreter().AdaptivePredict(p.BaseParser, p.GetTokenStream(), 56, p.GetParserRuleContext()) == 2 {
			p.SetState(565)

			if !(this.n("static")) {
				p.SetError(antlr.NewFailedPredicateException(p, "this.n(\"static\")", ""))
				goto errorExit
			}
			{
				p.SetState(566)
		...
		if p.GetInterpreter().AdaptivePredict(p.BaseParser, p.GetTokenStream(), 57, p.GetParserRuleContext()) == 1 {
			{
				...
				goto errorExit} else if p.GetInterpreter().AdaptivePredict(p.BaseParser, p.GetTokenStream(), 57, p.GetParserRuleContext()) == 2 {
			p.SetState(571)
...
func (s *ClassElementNameContext) EnterRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(JavaScriptParserListener); ok {
		listenerT.EnterClassElementName(s)
	}
}

func (s *ClassElementNameContext) ExitRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(JavaScriptParserListener); ok {
		listenerT.ExitClassElementName(s)
	}
}
...
func (s *PrivateIdentifierContext) EnterRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(JavaScriptParserListener); ok {
		listenerT.EnterPrivateIdentifier(s)
	}
}

func (s *PrivateIdentifierContext) ExitRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(JavaScriptParserListener); ok {
		listenerT.ExitPrivateIdentifier(s)
	}
}
...
func (p *JavaScriptParser) Getter() (localctx IGetterContext) {
	...
	if !(this.n("get")) {
		p.SetError(antlr.NewFailedPredicateException(p, "this.n(\"get\")", ""))
		goto errorExit
	}
	{
		p.SetState(1016)
...
func (p *JavaScriptParser) Setter() (localctx ISetterContext) {
	...
	if !(this.n("set")) {
		p.SetError(antlr.NewFailedPredicateException(p, "this.n(\"set\")", ""))
		goto errorExit
	}
	{
		p.SetState(1020)
...
func (p *JavaScriptParser) Eos() (localctx IEosContext) {
	...
	case 3:
		...
		if !(this.lineTerminatorAhead()) {
			p.SetError(antlr.NewFailedPredicateException(p, "this.lineTerminatorAhead()", ""))
			goto errorExit
		}
	...
	case 4:
		...
		if !(this.closeBrace()) {
			p.SetError(antlr.NewFailedPredicateException(p, "this.closeBrace()", ""))
			goto errorExit
		}
...
func (p *JavaScriptParser) Sempred(localctx antlr.RuleContext, ruleIndex, predIndex int) bool {
	...
	case 78:
			...
			if localctx != nil { t = localctx.(*GetterContext) }
			return p.Getter_Sempred(t, predIndex)

	case 79:
			var t *SetterContext = nil
			if localctx != nil { t = localctx.(*SetterContext) }
			return p.Setter_Sempred(t, predIndex)

	case 85:
			var t *EosContext = nil
			if localctx != nil { t = localctx.(*EosContext) }
