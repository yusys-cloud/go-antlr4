...
type JavaScriptParserListener interface {
	...
	EnterClassElementName(c *ClassElementNameContext)

	// EnterPrivateIdentifier is called when entering the privateIdentifier production.
	EnterPrivateIdentifier(c *PrivateIdentifierContext)
	...
	EnterOptionalChainExpression(c *OptionalChainExpressionContext)
	...
	ExitClassElementName(c *ClassElementNameContext)

	// ExitPrivateIdentifier is called when exiting the privateIdentifier production.
	ExitPrivateIdentifier(c *PrivateIdentifierContext)
	...
	ExitOptionalChainExpression(c *OptionalChainExpressionContext)
